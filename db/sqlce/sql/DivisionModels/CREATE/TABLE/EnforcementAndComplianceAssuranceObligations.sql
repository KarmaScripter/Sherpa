CREATE TABLE EnforcementAndComplianceAssuranceDivisionObligations
(
	EnforcementAndComplianceAssuranceDivisionObligationId INTEGER NOT NULL UNIQUE CONSTRAINT
		PK_EnforcementAndComplianceAssuranceDivisionObligations PRIMARY KEY,
	...
	Used DOUBLE NULL,
    CONSTRAINT FK_EnforcementAndComplianceAssuranceDivisionObligations 
