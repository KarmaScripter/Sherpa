...
(
	EnvironmentalJusticeObligationId INTEGER NOT NULL UNIQUE CONSTRAINT PK_EnvironmentalJusticeObligations PRIMARY KEY,
	...
	Used DOUBLE NULL,
	CONSTRAINT FK_EnvironmentalJusticeObligations 
