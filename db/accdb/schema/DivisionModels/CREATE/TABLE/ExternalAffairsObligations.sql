CREATE TABLE ExternalAffairsDivisionObligations
(
	ExternalAffairsDivisionObligationId INTEGER NOT NULL UNIQUE CONSTRAINT PK_ExternalAffairsDivisionObligations PRIMARY KEY,
	...
	Used DOUBLE NULL,
	CONSTRAINT FK_ExternalAffairsDivisionObligations 
