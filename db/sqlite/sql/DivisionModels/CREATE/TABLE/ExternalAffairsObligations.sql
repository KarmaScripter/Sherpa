...
(
	ExternalAffairsDivisionObligationId INTEGER NOT NULL UNIQUE CONSTRAINT PrimaryKeyExternalAffairsDivisionObligations PRIMARY KEY,
	...
	Used DOUBLE NULL,
	CONSTRAINT ForeignKeyExternalAffairsDivisionObligations 
