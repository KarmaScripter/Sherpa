CREATE TABLE EnforcementAndComplianceAssuranceObligations
(
	EnforcementAndComplianceAssuranceDivisionObligationId INTEGER NOT NULL UNIQUE CONSTRAINT
		PrimaryKeyEnforcementAndComplianceAssuranceDivisionObligations PRIMARY KEY,
	...
	Used DOUBLE NULL,
    CONSTRAINT ForeignKeyEnforcementAndComplianceAssuranceDivisionObligations 
