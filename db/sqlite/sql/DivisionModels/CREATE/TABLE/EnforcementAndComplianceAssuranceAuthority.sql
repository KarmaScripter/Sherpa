...
(
	EnforcementAndComplianceAssuranceAuthorityId INTEGER NOT NULL UNIQUE CONSTRAINT 
		PrimaryKeyEnforcementAndComplianceAssuranceAuthority PRIMARY KEY,
    ...
    CONSTRAINT ForeignKeyEnforcementAndComplianceAssuranceDivisionAuthority
    FOREIGN KEY (PrcId) 
