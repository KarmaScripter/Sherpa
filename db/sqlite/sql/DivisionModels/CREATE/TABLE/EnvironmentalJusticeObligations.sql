...
(
	EnvironmentalJusticeObligationId INTEGER NOT NULL UNIQUE CONSTRAINT PrimaryKeyEnvironmentalJusticeObligations PRIMARY KEY,
	...
	Used DOUBLE NULL,
	CONSTRAINT ForeignKeyEnvironmentalJusticeObligations 
